...
(function() {
	...
	*/
	...
	var name = 'Leandro';
	var qtnString = name.length; 

	for (var i = 0; i < qtnString; i++ ) {
	...
	*/
	...
	var fullName = 'leandro-pereira-santos';
	...
	*/
	...
	var names = ['Leandro', 'Roberto', 'Maria', 'Lucia', 'Claudia'];
	...
	*/
	...
	for (var i = 0; i < len; i ++ ) {
		newName.push(i % 2 === 1 ? myName[i].toLowerCase() : myName[i].toUpperCase());
	}
