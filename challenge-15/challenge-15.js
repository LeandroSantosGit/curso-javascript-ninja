...
(function() {
  ...
  */
  ...
  var pessoa1 = new Person('Claudia', 'Silva', 31);
  var pessoa2 = new Person('Antonia', 'Azevedo', 23);
  var pessoa3 = new Person('Jose', 'Carlos', 38);
  ...
  */
  ...
  console.log(pessoa1.getFullName() + ' agora tem ' + pessoa1.addAge(7).getAge() + ' anos.');
